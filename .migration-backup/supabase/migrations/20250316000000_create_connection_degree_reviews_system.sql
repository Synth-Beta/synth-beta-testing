...
--
-- This migration fixes the account_type type mismatch by casting enum to TEXT
-- ============================================

-- ============================================
-- STEP 1: CREATE FUNCTION TO CHECK RELEVANT 3RD DEGREE
-- ============================================
...
-- ============================================
-- STEP 2: CREATE MAIN VIEW FOR REVIEWS WITH CONNECTION DEGREES
-- ============================================
-- This view includes reviews from 1st, 2nd, and relevant 3rd degree connections
-- The account_type enum is cast to TEXT to match the function return type
-- Note: DROP first to allow changing column types (photos from jsonb to TEXT[])
...
-- ============================================
-- RPC function to fetch reviews with pagination support
