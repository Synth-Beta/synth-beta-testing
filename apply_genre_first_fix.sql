...
-- Create the get_user_genre_profile function first
...
BEGIN
  ...
  genre_weights AS (
    SELECT 
      genre,
      SUM(preference_score) as total_weight,
...
BEGIN
  ...
  ELSE
    -- Check if user has shown interest in this artist's events
