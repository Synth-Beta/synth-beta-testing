...
Deep brief (category definition, ICPs, DC/DMV wedge, consumer acquisition channels, partner distribution pipes, channel jobs, anti-goals): see `reference/niche-and-distribution.md`.

**Summary for agents:**

- Category: live music social discovery — not ticketing, not streaming, not generic listings.
- Public framing: Letterboxd for live music. Line: Discover, Connect, Share.
- Wedge: DC / DMV metro-first density, then clone city playbooks.
- Consumer channels: Instagram, TikTok/Reels, Substack, Reddit (trust), App Store/ASO, campus ambassadors, friend invites, streaming sync as activation.
- Partner pipes: independent venues, promoters, artists/managers, campus orgs, local writers, lifestyle/tourism — repeatable placements (QR, email footer, monthly Story), not one-off shoutouts.
- Content routing buckets: B2B LinkedIn · consumer short-form (IG/TikTok) · long-form Substack.
- Admin Content Calendar includes a three-level idea reservoir: umbrella angles → channel buckets → specific ideas (angle, channel, person, copy).
