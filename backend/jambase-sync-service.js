...
class JambaseSyncService {
  ...
  async upsertEvents(eventsData) {
    ...
    // CRITICAL: never delink an event from its artist/venue. Omit unresolved link
    // UUIDs so upsert preserves the existing FK on update instead of nulling it.
