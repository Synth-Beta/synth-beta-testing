                ...
                <div className="flex flex-col items-center justify-center h-full" style={{ gap: 'var(--spacing-inline, 6px)' }}>
                    ...
                    if (currentGroup.length > 0) {
                      ...
                      const prevGroup = groupIndex > 0 ? messageGroups[groupIndex - 1] : null;
                        ...
                        if (prevLastMessage) {
                          ...
                          // First group - start first session
                          currentSession.push(group);
                        }
                      });
                      ...
                      return sessions.map((session, sessionIndex) => {
                        ...
                        if (isWithinWeek) {
                          // Show day name only
                          sessionTimestamp = format(sessionDate, 'EEEE');
                        } else {
                          // Show abbreviated date
                          sessionTimestamp = format(sessionDate, 'MMM d');
                        }
                        sessionTimestamp += ` at ${format(sessionDate, 'h:mm a')}`;
                  ...
                  return (
                              ...
                              {group.map((message, msgIndex) => {
                                ...
                                return (
                                        <div key={message.id} className="flex flex-col" style={{ gap: isLastInGroup ? 'var(--spacing-inline, 6px)' : '0' }}>
