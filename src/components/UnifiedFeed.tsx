                ...
                {feedItems.filter(item => item.type === 'review' && !(item as any).deleted_at && !(item as any).is_deleted).map((item, index) => {
                  ...
                  <BelliStyleReviewCard
                    ...
                    review={{
                      ...
                      artist_performance_recommendation: (item as any).artist_performance_recommendation,
                      production_recommendation: (item as any).production_recommendation,
                      venue_recommendation: (item as any).venue_recommendation,
                      location_recommendation: (item as any).location_recommendation,
                      value_recommendation: (item as any).value_recommendation,
