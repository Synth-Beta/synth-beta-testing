...
export {
  ...
  WARMTH_MIN_DC_ICP_MEMBERS,
  WARMTH_MIN_HUMAN_MSGS_24H,
  CO_PRESENCE_SESSION_ONE_THRESHOLD,
  ROOM1_WARMTH_WEEKS_TO_UNLOCK_THIRD,
  LEGACY_PRODUCT_SCENE_ALIASES,
  normalizeProductSceneId,
  isPersistentProductSceneId,
  ...
  type PersistentProductSceneId,
  type ProductSceneJoinMode,
