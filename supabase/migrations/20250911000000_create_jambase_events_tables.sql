...
CREATE TABLE user_jambase_events (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
-- Create indexes
CREATE INDEX idx_jambase_events_jambase_event_id ON jambase_events(jambase_event_id);
CREATE INDEX idx_jambase_events_artist_name ON jambase_events(artist_name);
CREATE INDEX idx_jambase_events_venue_name ON jambase_events(venue_name);
CREATE INDEX idx_jambase_events_event_date ON jambase_events(event_date);
CREATE INDEX idx_user_jambase_events_user_id ON user_jambase_events(user_id);
