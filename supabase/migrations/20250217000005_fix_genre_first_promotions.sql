-- ============================================
-- FIX GENRE-FIRST ALGORITHM FOR PROMOTIONS
-- ============================================
-- Updates the genre-first algorithm to use JOIN with event_promotions table
-- instead of columns in jambase_events table

-- Update the calculate_event_relevance_score function to use JOIN for promotions
...
BEGIN
  ...
  -- Get user's top artists and calculate familiarity
  ...
  -- Calculate percentile for familiarity score
...
-- Update the get_personalized_events_feed function to include promotion fields via JOIN
...
BEGIN
  ...
  WITH scored_events AS (
    ...
    SELECT
      ...
      e.ticket_url,
      e.ticket_provider,
      e.ticket_provider_url,
      e.ticket_price_min,
      e.ticket_price_max,
      e.ticket_price_currency,
      ...
      e.venue_description,
      e.artist_website,
      e.artist_spotify_url,
      e.artist_instagram_url,
      e.artist_twitter_url,
      e.artist_facebook_url,
      e.artist_youtube_url,
      e.artist_soundcloud_url,
      e.artist_bandcamp_url,
      e.artist_website_url,
      e.tour_name,
      e.created_at,
      e.updated_at,
...
-- Verification
SELECT 
  'Genre-First Algorithm Fixed for Promotions' as status,
  'Promotion fields now included via JOIN with event_promotions table' as description;
